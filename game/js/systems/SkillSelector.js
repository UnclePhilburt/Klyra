...
class SkillSelector {
    ...
    setupKeyboardControls() {
        ...
        if (!this.scene.input || !this.scene.input.keyboard) {
            console.warn('⚠️ Keyboard input not available for SkillSelector');
            return;
        }
    ...
    hide() {
        ...
        if (this.key1 && typeof this.key1.removeAllListeners === 'function') {
            this.key1.removeAllListeners();
            this.key1 = null;
        }
        if (this.key2 && typeof this.key2.removeAllListeners === 'function') {
            this.key2.removeAllListeners();
            this.key2 = null;
        }
        if (this.key3 && typeof this.key3.removeAllListeners === 'function') {
