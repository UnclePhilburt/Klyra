...
class ScreenManager {
    ...
    async autoReconnect(session) {
        try {
            ...
            // Always skip lobby and go straight to game for any valid session
            console.log('⚡ Auto-reconnect detected - skipping main menu entirely');
            ...
            debug.info('CORE', 'Reconnecting to game (skipping menu)...');
            ...
            console.log('✅ Auto-reconnect successful - menu skipped!');
